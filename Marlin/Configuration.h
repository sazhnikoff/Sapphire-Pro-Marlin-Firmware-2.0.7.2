...
#define STRING_CONFIG_H_AUTHOR "(Pavel Sazhnikov, Sapphire Pro)" // Who made the changes.
...
#define MAX_BED_POWER 255 // limits duty cycle to bed; 255=full current
  ...
  #define DEFAULT_bedKp 56.5
  #define DEFAULT_bedKi 10.84
  #define DEFAULT_bedKd 190.2
